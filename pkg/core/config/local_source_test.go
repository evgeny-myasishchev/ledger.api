...
func TestLocalSource_GetParameters(t *testing.T) {
	...
	tests := []func() testCase{
		func() testCase {
			return testCase{
				name:   "default config",
				fields: fields{opts: []LocalOpt{WithDir(configDir)}},
				args: args{
					params: []param{
		...
		func() testCase {
			...
			return testCase{
				...
				fields: fields{opts: []LocalOpt{
					WithDir(configDir),
					WithAppEnv(AppEnv{ServiceName: serviceName}),
		...
		func() testCase {
			return testCase{
				...
				fields: fields{opts: []LocalOpt{
					WithDir(configDir),
					WithAppEnv(AppEnv{Name: "production"}),
				}},
				args: args{
					params: []param{
		...
		func() testCase {
			return testCase{
				...
				fields: fields{opts: []LocalOpt{
					WithDir(configDir),
					WithAppEnv(AppEnv{Name: "production", Facet: "preprod"}),
				}},
				args: args{
					params: []param{
						paramImpl{paramKey: "prod-key1"},
		...
		func() testCase {
			return testCase{
				...
				fields: fields{opts: []LocalOpt{WithDir(configDir + "-no-config")}},
				args: args{
		...
		func() testCase {
			return testCase{
				...
				fields: fields{opts: []LocalOpt{
					WithDir(configDir),
					WithAppEnv(AppEnv{Name: "no-staging", Facet: "no-facet"}),
				}},
				args: args{
					params: []param{
						paramImpl{paramKey: "key1"},
