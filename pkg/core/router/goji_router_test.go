...
func TestGojiRouterHandleToolkit(t *testing.T) {
	...
	ldTesting.JSONUnmarshalBuffer(w.Body, &actualPayload)
	...
	tests := []func() testCase{
		func() testCase {
			...
			return testCase{
				...
				fields: fields{
					body: ldTesting.JSONMarshalToReader(&want),
				},
			}
		},
		func() testCase {
		...
		func() testCase {
			...
			return testCase{
				...
				fields: fields{
					body: ldTesting.JSONMarshalToReader(p),
				},
				assert: func(t *testing.T, h HandlerToolkit) {
					var p payload
					err := h.BindPayload(&p)
		...
		func() testCase {
			...
			return testCase{
				...
				assert: func(t *testing.T, recorder *httptest.ResponseRecorder, err error) {
					...
					ldTesting.JSONUnmarshalBuffer(recorder.Body, &actualPayload)
