...
// TODO: Make sure to define String() for sources
// Since they're being logged
...
func (cfg *serviceConfig) getParamValue(key param) paramValue {
	...
	// TODO: Probably also log error here
...
func Load(opts ...ServiceConfigOpt) (ServiceConfig, error) {
	// TODO: Make sure to do proper logging of errors when doing init
